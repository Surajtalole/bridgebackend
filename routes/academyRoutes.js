...
const { createOrUpdateAcademyProfile,editAcademyProfile,getCoaches,getSports,getstudentbatch,getstudentFeeandAnalytics } = require('../controllers/academyProfileController');
...
router.get('/getSports/:coachId', getSports);
router.get('/:userId/:academyId/batch', getstudentbatch);
router.get('/:userId/:academyId/feeandanalytics', getstudentFeeandAnalytics);
