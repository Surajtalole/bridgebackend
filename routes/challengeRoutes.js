...
const {createChallenge, checkAlreadySuccess,getChallenges,togglePublish,deleteChallenge,updateChallenge,uploadChallengeVideo,checkAlreadySubmitted,getSubmittedChallenges,approveRequest,getPublishedChallenges } = require('../controllers/challengeController');
