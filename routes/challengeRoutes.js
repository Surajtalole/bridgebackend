...
const {createChallenge, checkAlreadySuccess,getChallenges,togglePublish,deleteChallenge,updateChallenge,uploadChallengeVideo,checkAlreadySubmitted,getSubmittedChallenges,approveRequest,getPublishedChallenges, rejectRequest } = require('../controllers/challengeController');
