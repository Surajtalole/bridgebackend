...
const createBatch = async (req, res) => {
  try {
    const { batchName, sport, batchId, startTime, endTime, startDate, endDate, planType, price } = req.body;
...
module.exports = { createBatch, getBatches,getAllBatches,enrollInTrial,getBatchesByAcademy };
