...
exports.bannerPromotion = async (req, res) => {
    try {
      const { bannerLink,bannerType, fromDate, toDate, publishOption,  } = req.body;
      console.log(bannerLink, fromDate, toDate,publishOption);
  
      if (!bannerLink || !bannerType || !fromDate || !toDate) {
