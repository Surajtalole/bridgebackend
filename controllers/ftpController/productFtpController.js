...
const REMOTE_DIR = "/domains/digitalcreations.co.in/public_html/athleap/ProductImages"
const FTP_SECURE = false;
const BASE_URL = "https://digitalcreations.co.in"; 

async function uploadProductToFTP(buffer, remoteFileName) {
  ...
  try {
    ...
    const fileUrl = `${BASE_URL}/athleap/ProductImages/${remoteFileName}`
...
module.exports = uploadProductToFTP
