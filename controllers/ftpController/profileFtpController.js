...
const REMOTE_DIR = "/domains/digitalcreations.co.in/public_html/athleap/Profile"; // Profile folder path
const FTP_SECURE = false;
const BASE_URL = "https://digitalcreations.co.in"; // Your website's base URL

async function uploadProfileImageToFTP(buffer, remoteFileName) {
  ...
  try {
    ...
    const fileUrl = `${BASE_URL}/athleap/Profile/${remoteFileName}`;
...
module.exports = uploadProfileImageToFTP;
