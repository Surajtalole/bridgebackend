...
const REMOTE_DIR = "/domains/digitalcreations.co.in/public_html/athleap/Invoices"; 
const FTP_SECURE = false;
const BASE_URL = "https://digitalcreations.co.in"; 

async function uploadInvoice(buffer, remoteFileName) {
  ...
  try {
    ...
    if (['.pdf',].includes(fileExtension)) {
      fileUrl = `${BASE_URL}/athleap/Invoices/${remoteFileName}`;
    }
