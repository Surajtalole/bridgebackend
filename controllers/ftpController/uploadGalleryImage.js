...
const REMOTE_DIR = "/domains/digitalcreations.co.in/public_html/athleap/GalleryImages"
const FTP_SECURE = false;
const BASE_URL = "https://digitalcreations.co.in"; 

async function uploadGalleryImageToFTP(buffer,remoteFileName){
  ...
  try {
    ...
    if (['.pdf', '.jpeg', '.jpg', '.png', '.gif', '.bmp', '.webp'].includes(fileExtension)) {
        fileUrl = `${BASE_URL}/athleap/GalleryImages/${remoteFileName}`
    }
...
module.exports = uploadGalleryImageToFTP;
