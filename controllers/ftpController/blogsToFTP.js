...
const REMOTE_DIR = "/domains/digitalcreations.co.in/public_html/athleap/BlogImages"
const FTP_SECURE = false;
const BASE_URL = "https://digitalcreations.co.in"; // Your website's base URL

async function uploadBlogsToFTP(buffer, remoteFileName) {
  ...
  try {
    ...
    const fileUrl = `${BASE_URL}/athleap/BlogImages/${remoteFileName}`
...
module.exports = uploadBlogsToFTP
